...
export const NewThread = ({ children }: Props) => {
  ...
  useEffect(() => {
    // If composer is already complete, don't do anything
  ...
  useEffect(() => {
    ...
    const handlePointerMove = (e: PointerEvent) => {
      ...
      // e.composedPath() returns an array of DOM elements that the pointer event passed through.
      // _savedComposedPath is a custom property added to the event object to save the composed path. This ensures that the path information is preserved even if the event object is reused or modified later.
